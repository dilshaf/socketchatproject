...
import {  addFriend, createPost,getAllPost,getPost, getUser, likePost, postComment, share, updateComment, updatedPost } from '../controllers/postController.js'
...
Postrouter.put('/put/:id',updatedPost)
